...
def find_zero_least_possiblities(possibilities):
    min_row_index = 10
    min_col_index = 10
    min_number = 10
    for row_index in range(len(possibilities)):
        for col_index in range (len(possibilities[row_index])):
            if len(possibilities[row_index][col_index]) > 0:
...
def solve_sudoku(sudoku):
    ...
    while len(stack) > 0:
        ...
        row_index, col_index = find_zero_least_possiblities(possibilities)
        ...
        possibilities[row_index][col_index] = []
